...
Page({
  ...
  onLoad: function(options) {
    ...
    wx.request({
      ...
      success(res) {
        ...
        that.setData({
          province: res.data.detail.province,
          area: res.data.detail.area,
          address: res.data.detail.address,
          city: res.data.detail.city,
          mobile: res.data.detail.mobile,
          realname: res.data.detail.realname,
          checked: res.data.detail.isdefault
        });
      }
    });
  },
  ...
  add() {
    var that = this
    if (this.data.realname.replace(/\s*/g, "") == "") {
      wx.showToast({
        title: "请填写姓名",
        icon: "none"
      });
    ...
    if(list.isdefault==true){
      list.isdefault=1
    }else if(list.isdefault==false){
      list.isdefault=0
    }
    console.log()
    wx.request({
      url: global.api + "&r=member.address.submit&timestamp=1568908398802",
      method: "POST",
      header: {
      ...
      data: {
        ...
        isdefault: list.isdefault?list.isdefault:that.data.checked
      },
      success() {
        wx.navigateBack({
          delta: 1
